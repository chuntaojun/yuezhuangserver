...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <sec:authorize access="hasRole('ADMIN')">
            ...
            <li class="active"><a href="/yue/report/admin"><span class="glyphicon glyphicon-stats"></span> 用户管理</a></li>
        ...
        <sec:authorize access="hasRole('USER')">
            <li class="active"><a href="/yue/report/user/<%=account  %>"><span class="glyphicon glyphicon-stats"></span> 数据报表</a></li>
        ...
        <li class="parent ">
            <a href="#">
                <span class="glyphicon glyphicon-list"></span> 更多功能
